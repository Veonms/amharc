...
def test_get_datetime_reading_successful(monkeypatch: pytest.MonkeyPatch):
    ...
    def mock_request(*args, **kwargs):
        return {"data": {"firstTs": 1717070400}}  # Thursday, 30 May 2024 12:00:00
    ...
    assert (
        client.retrieve_first_datetime_reading(resource_id="test-id")
        == "2024-05-30T12:00:00"
    )
...
def test_get_datetime_reading_unsuccessful_no_timestamp(
    ...
    with pytest.raises(NoFirstDateException):
        client.retrieve_first_datetime_reading(resource_id="test-id")
